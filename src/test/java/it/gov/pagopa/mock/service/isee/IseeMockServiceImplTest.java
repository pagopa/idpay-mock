...
class IseeMockServiceImplTest {
    ...
    void retrieveIsee_ShouldGenerateMock_WhenNotInMongo() {
        ...
        BigDecimal result = iseeMockService.retrieveIsee(cf, TipoIndicatoreEnum.ISEE_ORDINARIO);
    ...
    void retrieveIsee_ShouldReturnExisting_WhenFoundInMongo() {
        ...
        iseeMap.put(IseeTypologyEnum.ORDINARIO, BigDecimal.valueOf(5000));
    ...
    void saveIsee_ShouldThrowForUnhandledType() {
        String cf = "ABCDEF12G34H567I";
        Map<IseeTypologyEnum, BigDecimal> iseeMap = Map.of(IseeTypologyEnum.CORRENTE, BigDecimal.valueOf(1000));
